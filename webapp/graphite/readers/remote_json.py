...
class RemoteReader(BaseReader):
    ...
    def fetch_multi(self, startTime, endTime, now=None, requestContext=None):
        ...
        # This is tailored for the json response from carbonserver built into go-carbon
        data = json.loads(results).get("metrics")
            ...
            return [
                {
                    ...
                    'name': series['name'],
                    'time_info': (series['startTime'], series['stopTime'], series['stepTime']),
